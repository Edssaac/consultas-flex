<main class="container">
    <div class="jumbotron bg-opacity-50 rounded text-center my-5 py-5">
        ...
        <p class="mx-2">Digite um CEP válido e tenha acesso a todas as informações disponíveis</p>
    </div>
        ...
        <div class="row">
            <form class="col-lg-3 text-dark mx-3 mt-3" id="fetchData">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <div class="spinner-border text-primary text-opacity-50 d-none" role="status">
            ...
            <form class="col text-dark mx-3 my-3">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="localidade" id="localidade" placeholder="São Paulo" disabled readonly>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="uf" class="form-label">Estado</label>
                        <input type="text" class="form-control" name="uf" id="uf" placeholder="SP" disabled readonly>
                    </div>
                </div>

                <div class="mb-3">
                    <label for="logradouro" class="form-label">Logradouro</label>
                    <input type="text" class="form-control" name="logradouro" id="logradouro" placeholder="Praça da Sé" disabled readonly>
                </div>

                <div class="mb-3">
                    <label for="bairro" class="form-label">Bairro</label>
                    <input type="text" class="form-control" name="bairro" id="bairro" placeholder="Sé" disabled readonly>
                </div>

                <div class="mb-3">
                    <label for="complemento" class="form-label">Complemento</label>
                    <input type="text" class="form-control" name="complemento" id="complemento" placeholder="lado ímpar" disabled readonly>
                </div>
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="ibge" id="ibge" placeholder="3550308" disabled readonly>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="gia" id="gia" placeholder="1004" disabled readonly>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="siafi" id="siafi" placeholder="7107" disabled readonly>
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="ddd" id="ddd" placeholder="11" disabled readonly>
                    </div>
                </div>
            </form>
        </div>
